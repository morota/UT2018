...
- $\mathbf{Z'Z} + \lambda \mathbf{I}$ is the 4 x 4 diagonal matrix counting the number of phenotypes observed for each genotype + $\lambda$ values in the diagonal elements
